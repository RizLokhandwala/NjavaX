...
// code by Sparsh_cbs
// Read full article at: https://www.geeksforgeeks.org/round-robin-scheduling-with-different-arrival-times/
import java.util.*;
...
public class RoundRobin{
    ...
    public static void main(String[] args){
        ...
        // Higher quanta implements more first come first serve
        //lower quanta results in higher context switching
        tq = 2; //inp.nextInt();

        // Number of active threads should be taken
